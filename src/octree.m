        ...
        function splitNodeAtLevelL(this, l)
            ...
            for i = 1:size(splitVec,1) % goes trough all nodes in parallel
                if splitVec(i) > 0 % node need split
                    ...
                    BorderChilds = determineBorders(parent{l,i}.borders);
...
%                     plotOctree(parentBorders, BorderChild);
                    ...
                    [points_000, points_001, points_010, points_011, points_100, points_101, points_110, points_111] = sortPointsToChilds(parent{l,i}.points, BorderChilds);
                    ...
                    temp(1) = octreeNode(points_000, [parent{l,i}.xyzKey '000'], BorderChilds(1,:));
                    temp(2) = octreeNode(points_001, [parent{l,i}.xyzKey '001'], BorderChilds(2,:));
                    temp(3) = octreeNode(points_010, [parent{l,i}.xyzKey '010'], BorderChilds(3,:));
                    temp(4) = octreeNode(points_011, [parent{l,i}.xyzKey '011'], BorderChilds(4,:));
                    temp(5) = octreeNode(points_100, [parent{l,i}.xyzKey '100'], BorderChilds(5,:));
                    temp(6) = octreeNode(points_101, [parent{l,i}.xyzKey '101'], BorderChilds(6,:));
                    temp(7) = octreeNode(points_110, [parent{l,i}.xyzKey '110'], BorderChilds(7,:));
                    temp(8) = octreeNode(points_111, [parent{l,i}.xyzKey '111'], BorderChilds(8,:));
                    childNodes(i,:) = temp;
                end %if
            end %parfor
